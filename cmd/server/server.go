...
import (
	kplamqp "cloud-paas/src/amqp"
	"cloud-paas/src/casbin"
	"cloud-paas/src/email"
	"cloud-paas/src/git-repo"
	"cloud-paas/src/istio"
	"cloud-paas/src/jenkins"
	kpljwt "cloud-paas/src/jwt"
	"cloud-paas/src/kubernetes"
	"cloud-paas/src/logging"
	"cloud-paas/src/middleware"
	"cloud-paas/src/nacos"
	"cloud-paas/src/pkg/account"
	"cloud-paas/src/pkg/audit"
	"cloud-paas/src/pkg/auth"
	"cloud-paas/src/pkg/build"
	"cloud-paas/src/pkg/configmap"
	"cloud-paas/src/pkg/consul"
	"cloud-paas/src/pkg/cronjob"
	"cloud-paas/src/pkg/deployment"
	"cloud-paas/src/pkg/discovery"
	"cloud-paas/src/pkg/event"
	"cloud-paas/src/pkg/git"
	"cloud-paas/src/pkg/group"
	"cloud-paas/src/pkg/hooks"
	"cloud-paas/src/pkg/ingress"
	"cloud-paas/src/pkg/market"
	"cloud-paas/src/pkg/member"
	"cloud-paas/src/pkg/monitor"
	"cloud-paas/src/pkg/msgs"
	"cloud-paas/src/pkg/namespace"
	"cloud-paas/src/pkg/notice"
	"cloud-paas/src/pkg/permission"
	"cloud-paas/src/pkg/persistentvolume"
	"cloud-paas/src/pkg/persistentvolumeclaim"
	"cloud-paas/src/pkg/pod"
	"cloud-paas/src/pkg/proclaim"
	"cloud-paas/src/pkg/project"
	"cloud-paas/src/pkg/public"
	"cloud-paas/src/pkg/role"
	"cloud-paas/src/pkg/statistics"
	"cloud-paas/src/pkg/storage"
	"cloud-paas/src/pkg/template"
	"cloud-paas/src/pkg/terminal"
	"cloud-paas/src/pkg/tools"
	"cloud-paas/src/pkg/virtualservice"
	"cloud-paas/src/pkg/wechat"
	"cloud-paas/src/pkg/workspace"
...
func run() {
	...
	// nacos client
	_, err = nacos.NewNacosClient(cf)
	if err != nil {
		_ = level.Error(logger).Log("nacos", "NewClient", "err", err)
		panic(err)
	}
